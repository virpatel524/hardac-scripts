...
if not os.path.isdir('/home/vdp5/data/poptests/nsl/output/{}/{}/'.format(args.sample, args.range)):
	os.mkdir('/home/vdp5/data/poptests/nsl/output/{}/{}/'.format(args.sample, args.range))

if not os.path.isdir('/home/vdp5/data/poptests/nsl/output/{}/{}/vcf/'.format(args.sample, args.range)):
	os.mkdir('/home/vdp5/data/poptests/nsl/output/{}/{}/vcf/'.format(args.sample, args.range))

if not os.path.isdir('/home/vdp5/data/poptests/nsl/output/{}/{}/fasta/'.format(args.sample, args.range)):
	os.mkdir('/home/vdp5/data/poptests/nsl/output/{}/{}/fasta/'.format(args.sample, args.range))
...
for beta in topsets:
	...
	newstr = 'java -Xmx15000m -jar /gpfs/fs0/data/wraycompute/vdp5/src/GenomeAnalysisTK.jar -T SelectVariants -V {} -R /gpfs/fs0/data/wraycompute/vdp5/reference_data/PVP01.fasta -L {} -o /home/vdp5/data/poptests/nsl/output/{}/{}/vcf/{}_{}_{}-range.vcf'.format(args.mastervcf, '{}:{}-{}'.format(beta[0], start, end), args.sample, args.range, beta[0], beta[1], args.range)
	process = subprocess.Popen([newstr,], stdout=subprocess.PIPE,shell=True)
	process.wait()

	newstr = 'bgzip -c /home/vdp5/data/poptests/nsl/output/{}/{}/vcf/{}_{}_{}-range.vcf > /home/vdp5/data/poptests/nsl/output/{}/{}/vcf/{}_{}_{}-range.vcf.gz'.format(args.sample, args.range, beta[0], beta[1], args.range, args.sample, args.range, beta[0], beta[1], args.range)
	process = subprocess.Popen([newstr,], stdout=subprocess.PIPE,shell=True)
	process.wait()

	newstr = 'tabix -p vcf /home/vdp5/data/poptests/nsl/output/{}/{}/vcf/{}_{}_{}-range.vcf.gz'.format(args.sample, args.range, beta[0], beta[1], args.range)
	process = subprocess.Popen([newstr,], stdout=subprocess.PIPE,shell=True)
	process.wait()


	bigtab_str = '/home/vdp5/data/poptests/nsl/output/{}/{}/vcf/{}_{}_{}-range.tab'.format(args.sample, args.range, beta[0], beta[1], args.range)
	newstr = 'zcat /home/vdp5/data/poptests/nsl/output/{}/{}/vcf/{}_{}_{}-range.vcf.gz | vcf-to-tab > {}'.format(args.sample, args.range, beta[0], beta[1], args.range, bigtab_str)
	process = subprocess.Popen([newstr,], stdout=subprocess.PIPE,shell=True)
	process.wait()
	...
	newstr = 'java -Xmx15000m -jar /gpfs/fs0/data/wraycompute/vdp5/src/GenomeAnalysisTK.jar -T SelectVariants -V /home/vdp5/data/poptests/nsl/output/{}/{}/vcf/{}_{}_{}-range.vcf -R /gpfs/fs0/data/wraycompute/vdp5/reference_data/PVP01.fasta  -o /home/vdp5/data/poptests/nsl/output/{}/{}/vcf/{}_{}_{}-range.nonmissing.vcf -sf /home/vdp5/data/tmp/sampleitems_{}_{}.list'.format(args.sample, args.range, beta[0], beta[1], args.range, args.sample, args.range, beta[0], beta[1], args.range, args.range, args.sample)
	process = subprocess.Popen([newstr,], stdout=subprocess.PIPE,shell=True)
	process.wait()

	newstr = 'bgzip -c /home/vdp5/data/poptests/nsl/output/{}/{}/vcf/{}_{}_{}-range.nonmissing.vcf > /home/vdp5/data/poptests/nsl/output/{}/{}/vcf/{}_{}_{}-range.nonmissing.vcf.gz'.format(args.sample, args.range, beta[0], beta[1], args.range, args.sample, args.range, beta[0], beta[1], args.range)
	process = subprocess.Popen([newstr,], stdout=subprocess.PIPE,shell=True)
	process.wait()

	newstr = 'tabix -p vcf /home/vdp5/data/poptests/nsl/output/{}/{}/vcf/{}_{}_{}-range.nonmissing.vcf.gz'.format(args.sample, args.range, beta[0], beta[1], args.range)
	process = subprocess.Popen([newstr,], stdout=subprocess.PIPE,shell=True)
	process.wait()
	...
	bigvcf_str = '/home/vdp5/data/poptests/nsl/output/{}/{}/vcf/{}_{}_{}-range.nonmissing.vcf.gz'.format(args.sample, args.range, beta[0], beta[1], args.range)
	bigfasta_str = '/home/vdp5/data/poptests/nsl/output/{}/{}/fasta/{}_{}_{}-range.nonmissing.fasta'.format(args.sample, args.range, beta[0], beta[1], args.range)
	bignexus_str = '/home/vdp5/data/poptests/nsl/output/{}/{}/fasta/{}_{}_{}-range.nonmissing'.format(args.sample, args.range, beta[0], beta[1], args.range)
	bigvcf_str_pruned = '/home/vdp5/data/poptests/nsl/output/{}/{}/vcf/{}_{}_{}-range.nonmissing.pruned'.format(args.sample, args.range, beta[0], beta[1], args.range)
	bigfasta_str_pruned = '/home/vdp5/data/poptests/nsl/output/{}/{}/fasta/{}_{}_{}-range.nonmissing.pruned.fasta'.format(args.sample, args.range, beta[0], beta[1], args.range)
